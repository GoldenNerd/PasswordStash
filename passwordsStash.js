...
const fetchBtn = document.querySelector("#newEntry");
...
function findClosestMatches() { // Grab search term a letter at a time and...
  ...
  console.log(`matchedSiteNames uppercased:`);
