...
function emptyLocalStorage() {
  ...
  alert(`Your browser tab will be reloaded, and \nthe App will switch to "Add Mode".`);

  console.log(`Reloading browser tab . . .  Done!!`);
  location.reload();
  console.log(`Done!!`);
}
const emptyLocalStorageBtn = document.getElementById("empty-localstorage");
emptyLocalStorageBtn.addEventListener("click", emptyLocalStorage);
...
function does_credentialsArrayExistsInLocalstorage() {
  ...
  console.log(`1st step: Calling the "retrieveFromLocalStorage()" function.`);
  let credentialsRetrieved = retrieveFromLocalStorage();
  ...
  if (credentialsRetrieved == null) {
    ...
    console.log(`Result:
  Upon calling, "retrieveFromLocalStorage()" function will return
...
function does_credentialsArrayContainsData() {
  console.log(
    `Running "does_credentialsArrayContainsData()" function.`
  );
  console.log(`1st step: Calling the "retrieveFromLocalStorage()" function.`);
  let credentialsRetrieved = retrieveFromLocalStorage();
  console.log(`Retrieved object:`);
...
isArrayEmptyBtn.addEventListener(
  "click",
  does_credentialsArrayContainsData
);
/* 
