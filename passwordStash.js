...
function saveCredentialsToLocalStorage(credentials) {
  ...
  /*
    document.getElementById(
      "notifications"
    ).innerHTML = "Credentials saved to My Password Stash.";
    setTimeout(() => {
...
function didUserInputTheSiteName() {
  ...
  if (nameValue == "") {
    ...
    showANotification(message, timeVisible);
    /*
        document.getElementById("notifications").innerHTML = `⚠  Sorry. Website name required.`;
        setTimeout(() => {
          document.getElementById("notifications").innerHTML = "";
        }, 4000);
    */
...
function deleteCredential() {
  ...
  if (nameOfSiteToBeDeleted == "") {
    ...
    //Display a notification for 4 seconds
    const message = `⚠ Nothing to delete.\nWebsite "Name" required.`;
    showANotification(message, timeVisible);
  } else {
  ...
  if (userProvidedASiteName) {
    ...
    if (
      ...
      */
      ...
      document.getElementById(
        "notifications"
      ).innerHTML = "⚠ Duplicate names are not allowed!!";
      setTimeout(() => {
        document.getElementById("notifications").innerHTML = "";
      }, 4000);
        */
...
//saveNewOrEditedCredentialBtn.addEventListener("click", credentialUpdater);
//saveNewOrEditedCredentialBtn.addEventListener("click", forbidenRequestHandler);
...
function selectBestSite() {
  ...
  if (userSelectedSiteName == "") {
    ...
    showANotification(message, timeVisible);
    /*document.getElementById("notifications").innerHTML = `⚠ Nothing to display.\nA website "Name" is required.`;
    setTimeout(() => {
      document.getElementById("notifications").innerHTML = "";
    }, 4000);
    */
...
function cancelChangesBtnService() {
  ...
  document.getElementById(
    "notifications"
  ).innerHTML = `Operation aborted. Nothing changed.`;
  document.getElementById("notifications").style.display = "block";
  setTimeout(function () {
    document.getElementById("notifications").style.display = "none";
  }, 5000);
...
function deleteACredentialBtnService() {
  ...
  if (confirm("Deletions can not be undone. Proceed?")) {
    ...
    //clearSearches();
    //clearAllData();
    //ocument.getElementById("name").focus();
