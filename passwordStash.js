...
function makeANewCredential() {
  ...
  if (secretQAsArrayReady) {
    newCredentialBeingBuilt["secretQAs"] = secretQAsArray;
    console.log(`Resetting the secretQAsArrayReady flag.:`);
    secretQAsArrayReady = false;
    console.log(`secretQAsArrayReady: ${secretQAsArrayReady}`);
  }
...
function isRequestToModifyCredentialAcceptable() {
  ...
  console.log(
    `My return variable is requestForModCredentialWasAccepted: ${requestForModCredentialWasAccepted}`
  );
...
function credentialUpdater() {
  ...
  if (requestToModifyCredentialWasAccepted) {
    ...
    const requestForNewCredentialGranted = true; // To fullfil requirement of credentialArchitect()
    credentialArchitect();
  } else {
    //Request not for Arquitect, let Updater give it a try.
    console.log(
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// Build the secretQAsArray by adding 10 instances of the secretQA object to an empty secretQAsArray array
let secretQAsArray;
let secretQAsArrayReady = false;
function addXtraQA() {
  ...
  secretQAsArrayReady = true;
  console.log(`My returned output is secretQAsArray:`);
  console.log(secretQAsArray);
  console.log(`I turned on the secretQAsArrayReady flag.:`);
  console.log(secretQAsArrayReady);
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
let siteNameSelectedForViewing;
function selectBestSite() {
  console.log(`I am the function selectBestSite()`);

  siteNameSelectedForViewing = document.getElementById("best-match-site")
    .innerHTML;
  console.log(`siteNameSelectedForViewing for function selectBestSite():`);
  console.log(siteNameSelectedForViewing);
  if (siteNameSelectedForViewing == "") {
    ...
    // console.log(`stored best siteNameSelectedForViewing:`);
    // console.log(siteNameSelectedForViewing);
    spoolToDisplay();
  }
}
...
function selectMiddleSite() {
  ...
  siteNameSelectedForViewing = document.getElementById("middle-match-site")
    .innerHTML;
  if (siteNameSelectedForViewing == "") {
    ...
    // console.log(`stored middle siteNameSelectedForViewing:`);
    // console.log(siteNameSelectedForViewing);
    spoolToDisplay();
  }
}
...
function selectLowestSite() {
  ...
  siteNameSelectedForViewing = document.getElementById("lowest-match-site")
    .innerHTML;
  if (siteNameSelectedForViewing == "") {
    //alert(`"⚠  Nothing to display. Name" required.`);
    //Display notification for 3 seconds
    ...
    // console.log(`stored lowest siteNameSelectedForViewing:`);
    // console.log(siteNameSelectedForViewing);
    spoolToDisplay();
  }
}
...
/*
function stashHealthRepair() {
  console.log(
    `There was an anomally on the permanent storage subsystem.\nAll credentials in Stash may have been lost.\nMemory repair could be compulsory. Repair now? Repair erases all data.`
  );
  if (
    confirm(
      `There was an anomally on the permanent storage subsystem.\nAll credentials in Stash may have been lost.\nMemory repair could be compulsory. Repair now? Repair erases all data.`
    ...
    loadEmptyCredentialsArrayToLocalStorage();
    location.reload();
    // Diaplay notification for 4 seconds
    const message = `Stash Repair completed. Continue.`;
    let timeVisible;
  showANotification(message, timeVisible);
  } else {
    switchToEditModeScreen();
    // Diaplay notification for 4 seconds
    const message = `Stash Repair cancelled.`;
    let timeVisible;
  showANotification(message, timeVisible);
  }
}
  ...
  if (credentialsArrayContainsData) {
    ...
    for (let index = 0; index < credentialsRetrieved.length; index++) {
      ...
      if (aCredential.name == siteNameToQuery) {
        ...
        credentialOfInterest = aCredential;
        console.log(`credentialOfInterest.name:`);
        console.log(credentialOfInterest.name);
      }
    }
...
function spoolToDisplay() {
  ...
  let siteNameToQuery = siteNameSelectedForViewing;
  let credentialOfInterest = queryACredentialBySiteName(siteNameToQuery);
  document.getElementById("name").value = credentialOfInterest.name;
  document.getElementById("website").value = credentialOfInterest.website;
  document.getElementById("email").value = credentialOfInterest.email;
  document.getElementById("username").value = credentialOfInterest.username;
  document.getElementById("password").value = credentialOfInterest.password;
  document.getElementById("pin").value = credentialOfInterest.pin;
  document.getElementById("recovery-email").value =
    credentialOfInterest.recoveryEmail;
  document.getElementById("secret-image").value =
    credentialOfInterest.secretImage;

  document.getElementById("question0").value =
    credentialOfInterest.secretQAs[0].secretQ;
  document.getElementById("answer0").value =
    credentialOfInterest.secretQAs[0].secretA;

  document.getElementById("question1").value =
    credentialOfInterest.secretQAs[1].secretQ;
  document.getElementById("answer1").value =
    credentialOfInterest.secretQAs[1].secretA;

  document.getElementById("question2").value =
    credentialOfInterest.secretQAs[2].secretQ;
  document.getElementById("answer2").value =
    credentialOfInterest.secretQAs[2].secretA;

  document.getElementById("question3").value =
    credentialOfInterest.secretQAs[3].secretQ;
  document.getElementById("answer3").value =
    credentialOfInterest.secretQAs[3].secretA;

  document.getElementById("question4").value =
    credentialOfInterest.secretQAs[4].secretQ;
  document.getElementById("answer4").value =
    credentialOfInterest.secretQAs[4].secretA;

  document.getElementById("question5").value =
    credentialOfInterest.secretQAs[5].secretQ;
  document.getElementById("answer5").value =
    credentialOfInterest.secretQAs[5].secretA;

  document.getElementById("question6").value =
    credentialOfInterest.secretQAs[6].secretQ;
  document.getElementById("answer6").value =
    credentialOfInterest.secretQAs[6].secretA;

  document.getElementById("question7").value =
    credentialOfInterest.secretQAs[7].secretQ;
  document.getElementById("answer7").value =
    credentialOfInterest.secretQAs[7].secretA;

  document.getElementById("question8").value =
    credentialOfInterest.secretQAs[8].secretQ;
  document.getElementById("answer8").value =
    credentialOfInterest.secretQAs[8].secretA;

  document.getElementById("question9").value =
    credentialOfInterest.secretQAs[9].secretQ;
  document.getElementById("answer9").value =
    credentialOfInterest.secretQAs[9].secretA;

  //############## values for view mode: #############################
  document.getElementById("view-name").innerHTML = credentialOfInterest.name;
  document.getElementById("view-website").innerHTML =
    credentialOfInterest.website;
  document.getElementById("view-email").innerHTML = credentialOfInterest.email;
  document.getElementById("view-username").innerHTML =
    credentialOfInterest.username;
  document.getElementById("view-password").innerHTML =
    credentialOfInterest.password;
  document.getElementById("view-pin").innerHTML = credentialOfInterest.pin;
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
let bestMatchFlag; // global variable
let middleMatchFlag; // global variable
let lowestMatchFlag; // global variable
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
let devState = false; // global variable
...
function quit_innerHTMLdata() {
  ...
  const viewUsualDataStyle = document.querySelector("#view-usual-values").style;
  viewUsualDataStyle.display = "none";
  const viewQAataStyle = document.querySelector("#view-qs-and-as").style;
