...
function testAFunction() {
  ...
  //  function credentialArchitect() only handles the creation requests. 
  ...
  function isRequestToModifyCredentialAcceptable() {
    ...
    // Testing for: Request from AddMode, to create a new website credential, using an existing website name
    if (requestorForANewCredential == "AddMode" && websiteNameIsAlreadyInCredentials == true){
// Sorry. Your request to create a new credential was rejected.\nThe website name already exists in Your Password Stash.\nDuplicate names are not allowed.
alert(`Sorry. Your request to create a new credential was rejected.\nThe website name already exists in Your Password Stash.\nDuplicate names are not allowed.`);    
console.log(`Sorry. Your request to create a new credential was rejected.\nThe website name already exists in Your Password Stash.\nDuplicate names are not allowed.`);
}
    if (
      requestorForANewCredential == "EditMode" &&
      websiteNameIsAlreadyInCredentials == true
  ...
  function credentialUpdater() {
    ...
    if (requestToModifyCredentialWasAccepted) {
      ...
      console.log(
        `Congrats! Request to edit existing credential accepted.\n\nWe will edit the existing credential..\credentialUpdater() calling credentialUpdater();`
      );
      ...
      const requestForNewCredentialWasAccepted = true;
      credentialArchitect();

      function tempConcealer() {
        let matchFound = true;
  ...
  credentialUpdater();
  //  function notCreateNorModifyHandler() only handles the illegal requests. 
  function notCreateNorModifyHandler() {
    let requestForNewCredentialWasAccepted;
    const requestorForANewCredential = whoRequestedANewCredential();
    ...
    if (requestorForANewCredential == "AddMode" && websiteNameIsAlreadyInCredentials == true) {
      ...
      alert(`⚠ Sorry. Your request to create a new credential was rejected.\nAre you trying to modify a credential?\nThe website name already exists in Your Password Stash.\nDuplicate names are not allowed.`);
      console.log(`⚠ Sorry. Your request to create a new credential was rejected.\nThe website name already exists in Your Password Stash.\nAre you trying to modify a credential?\nDuplicate names are not allowed.`);
    }
  };
  notCreateNorModifyHandler();
}
